...
@Module({
  ...
  controllers: [CreateContactController, GetContactsController, GetContactController, EditContactController],
  providers: [CreateContactService, GetContactsService, GetContactService, EditContactService]
})
